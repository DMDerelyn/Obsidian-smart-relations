// CLAUDE.md content for deployment to user's vault
// This is the full CLAUDE.md embedded as a string so the plugin can write it
// to any vault folder without needing to read from the repo.

export const CLAUDE_MD_CONTENT = `# Smart Relations \u2014 Instructions for Claude Code
